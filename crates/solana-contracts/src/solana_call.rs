...
///
/// This struct is designed to be used with the [`SolanaCallBuilder`] to collect user-provided
...
impl<Id, Pi, In, C, A, Py> SolanaCallBuilder<Missing<state::RpcClient>, Id, Pi, In, C, A, Py> {
    ...
    /// # Returns
    ///
    /// Returns a new [`SolanaCallBuilder`] instance with the RPC URL option set.
    pub fn rpc_url<T: ToString>(
        self,
        rpc_url: T,
    ) -> SolanaCallBuilder<state::RpcClient, Id, Pi, In, C, A, Py> {
        SolanaCallBuilder {
            opts: SolanaCallOpts {
...
impl<Rp, Pi, In, C, A, Py> SolanaCallBuilder<Rp, Missing<state::Idl>, Pi, In, C, A, Py> {
    ...
    /// # Returns
    ///
    /// Returns a new [`SolanaCallBuilder`] instance with the Idl option set.
    pub fn idl<T: ToString>(self, idl: T) -> SolanaCallBuilder<Rp, state::Idl, Pi, In, C, A, Py> {
        SolanaCallBuilder {
            opts: SolanaCallOpts {
                idl: idl.to_string(),
                ..self.opts
...
impl<Rp, Id, In, C, A, Py> SolanaCallBuilder<Rp, Id, Missing<state::ProgramID>, In, C, A, Py> {
    ...
    /// # Returns
    ///
    /// Returns a new [`SolanaCallBuilder`] instance with the program ID option set.
    pub fn program_id<T: ToString>(
        self,
        program_id: T,
    ) -> SolanaCallBuilder<Rp, Id, state::ProgramID, In, C, A, Py> {
        SolanaCallBuilder {
            opts: SolanaCallOpts {
...
impl<Rp, Id, Pi, C, A, Py> SolanaCallBuilder<Rp, Id, Pi, Missing<state::Instruction>, C, A, Py> {
    ...
    /// # Returns
    ///
    /// Returns a new [`SolanaCallBuilder`] instance with the specified instruction set.
    pub fn instruction<T: ToString>(
        self,
        instruction: T,
    ) -> SolanaCallBuilder<Rp, Id, Pi, state::Instruction, C, A, Py> {
        SolanaCallBuilder {
            opts: SolanaCallOpts {
...
impl<Rp, Id, Pi, In, A, Py> SolanaCallBuilder<Rp, Id, Pi, In, Missing<state::CallData>, A, Py> {
    ...
    /// # Returns
    ///
    /// Returns a new [`SolanaCallBuilder`] instance with the specified call data set.
    pub fn call_data<S: ToString>(
        self,
        call_data: Vec<S>,
    ) -> SolanaCallBuilder<Rp, Id, Pi, In, state::CallData, A, Py> {
        SolanaCallBuilder {
            opts: SolanaCallOpts {
...
impl<Rp, Id, Pi, In, C, Py> SolanaCallBuilder<Rp, Id, Pi, In, C, Missing<state::Accounts>, Py> {
    ...
    /// # Returns
    ///
    /// Returns a new [`SolanaCallBuilder`] instance with the specified accounts set.
    pub fn accounts<S: ToString>(
        self,
        accounts: Vec<S>,
    ) -> SolanaCallBuilder<Rp, Id, Pi, In, C, state::Accounts, Py> {
        SolanaCallBuilder {
            opts: SolanaCallOpts {
...
impl<Rp, Id, Pi, In, C, A> SolanaCallBuilder<Rp, Id, Pi, In, C, A, Missing<state::Payer>> {
    ...
    /// # Returns
    ///
    /// Returns a new [`SolanaCallBuilder`] instance with the specified payer set.    
    pub fn payer<T: ToString>(
        self,
        payer: T,
    ) -> SolanaCallBuilder<Rp, Id, Pi, In, C, A, state::Payer> {
        SolanaCallBuilder {
            opts: SolanaCallOpts {
